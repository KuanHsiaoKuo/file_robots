        ...
        resources: {
            ...
            "zh-CN":{
                translation: {
                    ...
                    "rmenu-automation-basic_expense": "生成基本支出情况表",
                    "rmenu-automation-project_statistic": "项目收支统计处理",
                    "rmenu-config-template-basic_expense": "设置为基本支出情况表模版",
                    "rmenu-config-template-basic_expense-again": "重新设置基本支出情况表模版",
                    "rmenu-config-template-project_statistic": "设置为项目收支统计模版",
                    "rmenu-config-template-project_statistic-again": "重新设置项目收支统计模版",
